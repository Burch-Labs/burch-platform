...
export function GoogleButton({ callbackUrl = "/dashboard" }: GoogleButtonProps) {
  ...
  return (
    <button
      ...
      className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg py-2.5 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition disabled:opacity-50"
    >
      {/* Google "G" SVG */}

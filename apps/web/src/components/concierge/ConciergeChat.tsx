...
export function ConciergeChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm your dontbeboringKE AI Concierge. I can help you discover the best hotels, restaurants, and events across Kenya — or plan a full travel itinerary. What are you looking for today?",
    },
  ]);
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="border-t border-gray-100 bg-white px-4 sm:px-6 py-4">
        ...
        <p className="text-xs text-gray-400 mt-2 text-center">
          Powered by dontbeboringKE AI · Recommendations are based on live availability
        </p>
      </div>
    </div>
  );

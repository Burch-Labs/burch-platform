...
export default async function TicketWalletPage({
  ...
  return (
    <div className="min-h-screen bg-[#0C0E13] print:bg-surface">
      <main className="max-w-2xl mx-auto px-4 py-10 print:py-0">
        ...
        <div className="space-y-6">
          {tickets.map((t) => (
            <article
              key={t.id}
              className="rounded-[22px] bg-surface shadow-[0_30px_60px_-20px_rgba(15,26,46,0.35),0_4px_16px_-4px_rgba(15,26,46,0.15)] print:shadow-none print:border print:border-gray-200 print:break-inside-avoid"
            >
              {/* ── Stub: the part staff look at ── */}
              <div className="relative overflow-hidden rounded-t-[22px] bg-[radial-gradient(140%_100%_at_0%_0%,rgba(234,88,12,0.55),transparent_60%),linear-gradient(155deg,#0F1A2E_0%,#0A1220_68%)] px-6 py-6 print:bg-surface print:border-b print:border-gray-200">
              ...
              <div className="px-6 py-6 flex flex-col items-center">
                {t.svg ? (
                  <>
                    <div className="relative w-[216px] h-[216px] p-2.5 bg-surface rounded-2xl border border-gray-100">
                      <div
              ...
              <div className="rounded-b-[22px] bg-gray-50 px-6 py-3 print:bg-surface">
